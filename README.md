...
- DÃ©bloquer ~370 succÃ¨s et des titres exclusifs
...
â”‚
â”œâ”€â”€ commands/
â”‚   â”œâ”€â”€ joueur/         # commandes joueur (krosmoz, inventaire, market, guild, gift...)
â”‚   â”œâ”€â”€ admin/          # commandes admin (krosmoevent, stats)
â”‚   â””â”€â”€ dev/            # commandes dev (addcard, simpack, devguild...)
â”‚
â”œâ”€â”€ systems/
â”‚   â”œâ”€â”€ achievements/   # 12 fichiers d'achievements modulaires
â”‚   â”œâ”€â”€ eventHandlers/  # 19 handlers d'events (1 par Dieu)
â”‚   â”œâ”€â”€ guildSystem.js  # CRUD guildes, XP, niveaux
â”‚   â”œâ”€â”€ guildBonuses.js # Calcul des 9 bonus par niveau de guilde
â”‚   â”œâ”€â”€ guildQuestSystem.js # QuÃªtes hebdo de guilde (scaling dynamique)
â”‚   â”œâ”€â”€ playerBonuses.js # Calcul des 9 bonus par niveau du joueur
â”‚   â””â”€â”€ ...             # systÃ¨mes principaux
â”‚
â”œâ”€â”€ cards/
â”‚   â”œâ”€â”€ images/         # images des cartes (par set)
â”‚   â”œâ”€â”€ import/         # dossier d'import batch
â”‚   â””â”€â”€ sets.json       # dÃ©finition des sets
â”‚
â”œâ”€â”€ data/               # donnÃ©es persistantes
â”‚   â”œâ”€â”€ users/          # fichiers joueurs individuels
â”‚   â”œâ”€â”€ guilds.json     # donnÃ©es des guildes
â”‚   â”œâ”€â”€ market.json
â”‚   â”œâ”€â”€ marketHistory.json
â”‚   â”œâ”€â”€ devs.json
â”‚   â”œâ”€â”€ cards.json
â”‚   â””â”€â”€ krosmoshop.json
â”‚
â”œâ”€â”€ index.js
â”œâ”€â”€ CHANGELOG.md
â””â”€â”€ README.md
...
| achievementRegistry | AgrÃ©gateur des 12 modules d'achievements |
...
~370 succÃ¨s automatiques rÃ©partis en 12 catÃ©gories :
...
- **Niveaux** â€” 20 achievements (niveaux 5â†’100, XP total, secrets)
...
Le Battle Pass est stocke dans un espace dedie persistant :

- `data/battlepass/current_season.json`
- `data/battlepass/seasons/*.json`
- `data/battlepass/progress/<userId>.json`
- `data/battlepass/archive/*.json`
- `data/battlepass/global_achievements.json`
...
| /achievements | Voir les ~370 succÃ¨s |
...
```
    ...
    packEngine   eventPackEngine    market
        â”‚              â”‚              â”‚
        â””â”€â”€â”€â”€â”€â”€â–º userSystem â—„â”€â”€â”€â”€â”€â”€â”€â”€â”˜
                    â”‚     â”‚
...
Chaque joueur stocke : inventaire, shiny cards, kamas, pity, achievements, titres, progression, stats, krosmoshop, quÃªtes, guildId.

Chaque guilde stocke : nom, emoji, meneur, officiers, membres, niveau, XP, quÃªtes hebdo, stats.
