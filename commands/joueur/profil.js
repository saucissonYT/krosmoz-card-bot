...
module.exports = {
 ...
 async execute(interaction){
  ...
  const percent = Math.floor((ownedCards / totalCards) * 100)
  ...
  const embed = new EmbedBuilder()
   ...
   .addFields(
    ...
    {name:"📊 Progression XP",value:xpBar,inline:false},

    {name:"💰 Kamas",value:String(user.kamas || 0),inline:true},
    {name:"📦 Cartes",value:`${ownedCards}/${totalCards}`,inline:true},

    {name:"📊 Collection",value:`${collectionBar} ${percent}%`,inline:false},
...
📅 Daily : ${stats.dailyClaims || 0}`,
 ...
 /* ---------------- BOUTONS ---------------- */
  ...
  collector.on("collect", async i => {
   ...
   console.log("Bouton profil :",i.customId)
