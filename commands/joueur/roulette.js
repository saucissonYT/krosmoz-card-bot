...
// Salons autorises pour /roulette
...
/* ─────────────────────────────────────────────────────────────────────────────
   ...
   • Lot  8 : XP commun    100  → 200  XP
   • Lot 13 : XP peu commun 250 → 500  XP
   • Lot 19 : XP peu commun 500 → 1 000 XP
   • Lot 21 : Trésor Ecaflip     + 400 XP secondaire
   • Lot 25 : Grand Trésor       + 600 XP secondaire
   • Lot 27 : Fortune Ecaflip    + 1 500 XP secondaire
   Les IDs, poids et autres récompenses sont inchangés.
───────────────────────────────────────────────────────────────────────────── */
...
const LOTS = [
 ...
 { id:  8, emoji:"⭐", name:"Petite XP",          rarity:"commun",    weight:12,  reward:{ xp:200 } },
 ...
 { id: 13, emoji:"⭐", name:"XP solide",          rarity:"peucommun", weight: 8,  reward:{ xp:500 } },
 ...
 { id: 19, emoji:"⭐", name:"Bonne XP",           rarity:"peucommun", weight: 7,  reward:{ xp:1000 } },
 { id: 20, emoji:"🧩", name:"Double fragment",    rarity:"peucommun", weight: 7,  reward:{ fragments:2 } },

 { id: 21, emoji:"🪙", name:"Tresor d'Ecaflip",  rarity:"rare",      weight: 5,  reward:{ kamas:5000,  xp:400 } },
 ...
 { id: 25, emoji:"🪙", name:"Grand Tresor",       rarity:"rare",      weight: 4,  reward:{ kamas:7500,  xp:600 } },
 { id: 26, emoji:"📦", name:"Dix packs",          rarity:"rare",      weight: 4,  reward:{ packs:10 } },

 { id: 27, emoji:"🪙", name:"Fortune d'Ecaflip", rarity:"tresrare",  weight: 2,  reward:{ kamas:15000, xp:1500 } },
...
function grantRandomCard(user, rarity, options = {}) {
 ...
 return { id: card.id, name: card.name, rarity, shiny: Boolean(options.shiny) }
}
